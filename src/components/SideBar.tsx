  ...
  return (
    <>
      <div
        ...
        className={`${sidebarOpen ? "visible translate-x-0" : "invisible -translate-x-full"} absolute z-20 flex h-screen w-48 flex-col opacity-100 transition-all duration-300 ease-in-out sm:relative`}
        aria-label="Sidebar"
      >
          ...
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                ...
                <span className="ms-3 flex-1 whitespace-nowrap group-hover:text-blue-600 dark:group-hover:text-white">
                  Home
                </span>
              </Link>
            </li>
            ...
            <SignedIn>
              ...
              <li>
                ...
                >
                  ...
                  <span className="ms-3 whitespace-nowrap group-hover:text-blue-600 dark:group-hover:text-white">
                    Sign Out
                  </span>
                </button>
              </li>
