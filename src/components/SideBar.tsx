  ...
  return (
    <>
      <aside
        ...
        className="flex h-screen w-40 -translate-x-full flex-col transition-transform sm:translate-x-0"
        aria-label="Sidebar"
      >
        <div className="h-full overflow-y-auto bg-gray-300 px-3 py-3 dark:bg-gray-600">
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                <svg
                  className="h-5 w-5 text-gray-500 transition duration-75 group-hover:text-blue-600 dark:text-gray-400 dark:group-hover:text-white"
                  aria-hidden="true"
